...
# Version: 4.2s delete the ct from %ct if fail in soap_check. do soap using M0,M1,M2 for cowpea -- soybean
#**************************
...
use Getopt::Std;
getopts("hi:u:d:a:j:m:s:w:c:f:b:n:r:p:l:e:t:C:T:R:0:");
...
$h2p_set =~ s/\,/ /g;
	...
	printf STDERR ("\n R  %55s : %-25s\n\n","input minnimum ratio of duplex",$minRatio);
