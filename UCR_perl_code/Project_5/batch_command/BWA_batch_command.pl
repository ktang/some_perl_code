...
my $bwa_out_1 = $pre1."_default.sai";
	
 my $bwa_aln_cmd_1 = "bwa aln ~/Desktop/TAIR/BWA_index/TAIR9_Chr_all_bigBegin.fas $indir/$files[0] > $outdir/$bwa_out_1";
 
 my $bwa_out_2 = $pre2."_default.sai";
	
 my $bwa_aln_cmd_2 = "bwa aln ~/Desktop/TAIR/BWA_index/TAIR9_Chr_all_bigBegin.fas $indir/$files[1] > $outdir/$bwa_out_2";
 
 my $sam_file = $pre1."_".$pre2."_default.sam";
 my $bwa_sampe_cmd = "bwa sampe ~/Desktop/TAIR/BWA_index/TAIR9_Chr_all_bigBegin.fas $outdir/$bwa_out_1 $outdir/$bwa_out_2 $indir/$files[0] $indir/$files[1] > $outdir/$sam_file";
