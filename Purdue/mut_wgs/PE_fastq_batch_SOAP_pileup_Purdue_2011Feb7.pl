...
my $clean_pair1 = $pre1."_clean.fastq";
my $clean_pair2 = $pre2."_clean.fastq";
my $single_fastq  = $pre1."_".$pre2."_cleanSingle.fastq";
...
{
	my $cmd_pair = "time /Users/tang58/scripts_all/perl_code/Purdue/mut_wgs/find_pairs_for_pair_end_reads_v4_Purdue_2011Feb7.pl $indir/$in1 $indir/$in2 $indir/$clean_pair1 $indir/$clean_pair2 $indir/$single_fastq > $indir/$pair_stat";
