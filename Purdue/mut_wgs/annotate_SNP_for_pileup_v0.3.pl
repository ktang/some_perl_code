...
#v0.3 (incompelete same as v0.2)
# July 2, 2013
#input file like
#/Users/tang58/misc/Zhu_Xiaohong/July1_mutant_hr562_E-2172_results/E-2172_1_20.41M-21.99M_dep4_per0.5_mpileup_chr_TAIR10.txt

#chr     pos     ref     dep     seq     qual    Gene    Strand  GeneType        GeneAnnot       TE      TEFamily        Intergenic      Promoter_1kb
#chr1    20475919        C       13      gaaaaag+4aaaag+4aaaaa,,.^'.     !!!!!!##!?FJC   AT1G54923       -       transposable_element_gene       transposable element gene       AT1TE67645      ATGP2N:LTR/Gypsy        NONE    NONE
...
#my $snp_file = $ARGV[0];
my $snp_file = shift or die;
die unless (-e $snp_file);

my $ecotype_label = shift or die;


if ($ecotype_label eq 'Col0'){
	$seq_file = "/Users/tang58/DataBase/TAIR_Col0_genome/5Chr_only_TAIR9_Col0.fas";
}elsif($ecotype_label eq 'C24'){
