...
my $R_script = "/Users/tang58/scripts_all/perl_code/Purdue/Histone_src/histone_score/Nov21_read_density_RPKM/draw_DMRs_histone_RPKM_one_fig.r";
...
foreach my $file(@DMR_lists){
	if ( $file =~ /(\S+)_in_/) {
		my $list_pre = $1;
		my $out_pre = $list_pre . "_ChIP_RPKM";
