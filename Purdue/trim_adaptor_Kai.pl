...
sub summary{
	...
	print join("\t",($trim_13_over,$trim_12,$trim_11,$trim_10,$trim_9, $trim_8, $trim_7, $trim_6, $trim_5, $trim_4, $trim_3, $trim_2, $trim_1, $no_trim)),"\n";
}
...
\n");
	...
	die(@usage) if (@ARGV == 0);
	GetOptions(\%CMD, "adaptor=s", "input=s", "output=s","minLen");
