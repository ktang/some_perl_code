...
# bowtie2
#############
my $bam_file = File::Spec->catfile($outdir, $outpre . "_bowtie2_CP_k10.bam");
die if(-e $bam_file);
my $k = 10;
...
# sort
########
my $sorted_bam_pre = File::Spec->catfile($outdir, $outpre . "_bowtie2_CP_k10_sort");
my $sorted_bam = File::Spec->catfile($outdir, $outpre . "_bowtie2_CP_k10_sort.bam");
if(!$debug){
...
# rmdup
########
my $bam_rmdup = File::Spec->catfile($outdir, $outpre . "_bowtie2_CP_k10_sort_rmdup.bam");
