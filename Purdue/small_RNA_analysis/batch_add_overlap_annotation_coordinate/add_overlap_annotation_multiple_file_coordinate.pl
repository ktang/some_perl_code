...
my $script = "/Users/tang58/scripts_all/perl_code/Purdue/small_RNA_analysis/batch_add_overlap_annotation_coordinate/add_overlap_annotation_coordinate.pl";
die unless (-e $script);

print STDERR "\n\n script used is\n";
print STDERR $script, "\n\n";

my $usage = "$0 \n <orignal_file_list> <indir> <outdir> <output_name>\n\n";
...
my $cp_cmd = "cp -R $orignal_file $f0";
print STDERR $cp_cmd, "\n\n";
if(!$debug){
	`$cp_cmd`;
}
